...
fp_exl3_mgemm_kernel tfp_exl3_mgemm_kernel_fp32_b4[] = {
    EXL3_MGEMM_KERNEL_INSTANCES(4, true)
};

fp_exl3_mgemm_kernel tfp_exl3_mgemm_kernel_fp16_b4[] = {
    EXL3_MGEMM_KERNEL_INSTANCES(4, false)
};