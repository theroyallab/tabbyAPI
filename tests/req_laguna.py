...
MODEL = "/mnt/str/models/laguna-xs-2.1/exl3/4.00bpw_mul1/"

# Laguna's template defaults to enable_thinking: false
plain_request = {
    "model": MODEL,
...
# Enable reasoning via the top-level request field
thinking_request = {
    "model": MODEL,
...
def main():
    ...
    test_chat_request(api_key, BASE_URL, thinking_request.copy(), n=1)
    test_chat_streaming(api_key, BASE_URL, thinking_request.copy(), n=1)
