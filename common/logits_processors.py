...
from typing import Dict, FrozenSet, Iterable, List, Optional, Union, Callable

import torch
from transformers import PreTrainedTokenizer


LogitsProcessorFunc = Union[
    Callable[[List[int], torch.Tensor], torch.Tensor],
    Callable[[List[int], List[int], torch.Tensor], torch.Tensor],
]
"""LogitsProcessorFunc is a function that takes a list
