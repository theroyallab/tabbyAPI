...
| force_enable_thinking | Bool (False)                     | Inject `enable_thinking: True` into the template arguments. Some models need it to enter reasoning mode, and some clients don't send it.                                                                                       |
